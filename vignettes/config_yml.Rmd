...
# Documentation of the `config.yml` file
...
`benchmark_regions_select` is a path to a directory that contains ABCD data to be used. As an example:
...
`remove_inactive_companies` is a path to a directory that contains ABCD data to be used. As an example:
...
`apply_sector_split` is a path to a directory that contains ABCD data to be used. As an example:

    apply_sector_split: TRUE

#### sector_split_type

`sector_split_type` is a path to a directory that contains ABCD data to be used. As an example:
...
`dir_split_company_id` is a path to a directory that contains ABCD data to be used. As an example:

    dir_split_company_id: "~/Desktop/test/split"

#### filename_split_company_id

`filename_split_company_id` is a path to a directory that contains ABCD data to be used. As an example:

    filename_split_company_id: "split_company_ids.csv"

#### dir_advanced_company_indicators

`dir_advanced_company_indicators` is a path to a directory that contains ABCD data to be used. As an example:

    dir_advanced_company_indicators: "~/data/pactarawdata/asset-impact/2024-02-15_AI_RMI_2023Q4"

#### filename_advanced_company_indicators

`filename_advanced_company_indicators` is a path to a directory that contains ABCD data to be used. As an example:

    filename_advanced_company_indicators: "2024-02-14_AI_2023Q4_RMI-Company-Indicators.xlsx"

#### sheet_advanced_company_indicators

`sheet_advanced_company_indicators` is a path to a directory that contains ABCD data to be used. As an example:
...
`priority` is a path to a directory that contains ABCD data to be used. As an example:
...
`plot_width` is a path to a directory that contains ABCD data to be used. As an example:

    plot_width: 12

#### plot_height

`plot_height` is a path to a directory that contains ABCD data to be used. As an example:

    plot_height: 8

#### plot_units

`plot_units` is a path to a directory that contains ABCD data to be used. As an example:

    plot_units: "in"

#### plot_resolution

`plot_resolution` is a path to a directory that contains ABCD data to be used. As an example:
...
`by_group` is a path to a directory that contains ABCD data to be used. As an example:
