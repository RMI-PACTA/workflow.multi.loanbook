...
`min_score` Further explanation of this argument can be found in the documentation for `r2dii.match::match_name()`. As an example:
 
    min_score: 0.9

#### method

`method` Further explanation of this argument can be found in the documentation for `r2dii.match::match_name()`. As an example:

    method: "jw"

#### p

`p` Further explanation of this argument can be found in the documentation for `r2dii.match::match_name()`. As an example:
...
`join_id` Further explanation of this argument can be found in the documentation for `r2dii.match::match_name()`. As an example:
